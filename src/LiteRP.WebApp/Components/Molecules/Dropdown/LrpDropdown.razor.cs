...
/// </remarks>
public partial class LrpDropdown : IDisposable
{
    ...
    /// </example>
    [Parameter]
    public LrpDropdownSize Size { get; set; } = LrpDropdownSize.Medium;
    ...
    private LrpButtonSize GetButtonSize()
    {
        return Size switch
        {
            LrpDropdownSize.Small => LrpButtonSize.Small,
            LrpDropdownSize.Large => LrpButtonSize.Large,
            _ => LrpButtonSize.Medium
        };
    }
    ...
    private string GetTriggerClasses()
    {
        ...
        {
            LrpDropdownSize.Small => "px-2 py-1 text-xs",
            LrpDropdownSize.Large => "px-6 py-3 text-base",
    ...
    private string GetMenuClasses()
    {
        ...
        var alignmentClass = Placement switch
        {
            ...
            DropdownPlacement.Top or DropdownPlacement.Bottom => "left-1/2 -translate-x-1/2",
        ...
        {
            "absolute z-50 min-w-[180px] rounded shadow focus:outline-none",
